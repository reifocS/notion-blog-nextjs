...
import useTypewriterEffect, { Cursor, deleteAll, deleteSome, type } from "../components/useTypewriterEffect";
...
function temp() {
    ...
    return (
        <main className={styles.container}>
            ...
            <p className={typewriterStyles.shell}>{state}<Cursor className={typewriterStyles.Cursor} typing={isTyping} /></p>
        </main>
    );
}
